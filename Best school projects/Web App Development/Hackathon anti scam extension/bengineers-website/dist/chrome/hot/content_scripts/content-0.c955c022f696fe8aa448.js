...
const app = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_2__.initializeApp)(firebaseConfig);
...
function _getPost() {
    _getPost = _async_to_generator(function*(postid) {
        ...
        const postsCol = (0,_firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.collection)(db, 'posts');
        const querySnapshot = yield (0,_firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.getDocs)(postsCol);
...
function _addPost() {
    _addPost = _async_to_generator(function*(postid, approvednotes, reliabilitytag, sourcetag, timestamp, topictag, unapprovednotes, content) {
        ...
        if (postDoc) {
            ...
            yield (0,_firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.updateDoc)(docRef, {
                approvednotes: [
            ...
            const db = (0,_firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.getFirestore)(app);
            const postsCol = (0,_firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.collection)(db, 'posts');
            yield (0,_firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.addDoc)(postsCol, {
                approvednotes,
                postid,
                reliabilitytag,
                sourcetag,
        ...
        function _processElement() {
            ...
            _async_to_generator(function*(element) {
                ...
                if (parent.querySelector('button') === null) {
                    ...
                    let sourceTag1 = "None Yet";
                    let topicTags1 = [
                        "None"
                    ];
                    let reliabilityTag1 = "None Yet";
                    let communityNote1 = "None Yet";
                    if (postData) {
                        sourceTag1 = getMostFrequentTag(postData.sourcetag) || "None Yet";
                        topicTags1 = postData.topictag || [
                            "None"
                        ];
                        reliabilityTag1 = getMostFrequentTag(postData.reliabilitytag) || "None Yet";
                        communityNote1 = postData.approvednotes || "None Yet";
                    } else {
                        var sourceTag = "None Yet";
                        var topicTags = [
                            "None"
                        ];
                        var reliabilityTag = "None Yet";
                        var communityNote = "None Yet";
                    }
                    // Create and append the source tag
                    const sourceTagDiv = document.createElement('div');
                    sourceTagDiv.className = 'tag source-tag';
                    sourceTagDiv.textContent = sourceTag1; // Assuming sourceTag is a variable holding a string
                    ...
                    reliabilityTagDiv.textContent = reliabilityTag1; // Assuming reliabilityTag is a variable holding a string
                    ...
                    notesP.innerHTML = /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("span", {
                        class: "title",
                        children: "Notes: "
                    }, void 0, false, {
                        fileName: "C:\\Users\\benja\\Desktop\\bengineers\\content\\ContentApp.tsx",
                        lineNumber: 219,
                        columnNumber: 40
                    }, this) + communityNote1;
                    ...
                    var tagsOutput = "";
                    for(var i = 0; i < topicTags1.length; i++){
                        tagsOutput += '<span class="user-topic">' + topicTags1[i] + "</span>";
                    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("22f7a452f8b357418b07")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=content-0.c955c022f696fe8aa448.js.map